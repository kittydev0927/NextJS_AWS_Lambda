...
import {
  ...
  StyledTrashButton,
} from './SavedHomesPage.styles';
import type { SavedHomesPageProps } from './SavedHomesPage.types';

export const SavedHomesPage: React.FC<SavedHomesPageProps> = props => {
  return (
...
export const SavedHomesComponent: React.FC = () => {
